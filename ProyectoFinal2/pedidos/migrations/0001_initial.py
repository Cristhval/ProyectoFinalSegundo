    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('estado', models.CharField(choices=[('EN_PREPARACION', 'En Preparacion'), ('PAGADO', 'Pagado'), ('PENDIENTE', 'Pendiente'), ('PREPARADO', 'Preparado'), ('SERVIDO', 'Servido'), ('RESERVADO', 'Reservado')], default='PENDIENTE', max_length=50)),
            ],
        ),
        migrations.CreateModel(
